    ...
    public partial class FTRecordForm : Form, ILogDisp, IParentModule
    {
       ...
       // private CtlcorePresenter corePresenter;
        ...
        public FTRecordForm()
        {
            ...
            string dbAddr = ConfigurationManager.AppSettings["dbAddr"];
            FTDataAccess.DBUtility.PubConstant.ConnectionString = string.Format("Data Source ={0};Initial Catalog=FangTAIZaojuA;User ID=sa;Password=123456;", dbAddr);
           // FTDataAccess.DBUtility.PubConstant.ConnectionString = "Data Source = 127.0.0.1\\SQLEXPRESS;Initial Catalog=FangTAIZaojuA;User ID=sa;Password=123456;";
        }
