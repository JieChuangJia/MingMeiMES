...
namespace DBAccess.DAL
{
    ...
    public partial class BatteryPackDal
    {
        ...
        public bool Add(DBAccess.Model.BatteryPackModel model)
        {
            ...
            strSql.Append("batPackID,packAsmTime,opWorkerID,bmsID,tag1,tag2,tag3,tag4,tag5)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@bmsID", SqlDbType.NVarChar,50),
            ...
            parameters[3].Value = model.bmsID;
        ...
        public bool Update(DBAccess.Model.BatteryPackModel model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@batPackID", SqlDbType.NVarChar,50),
					new SqlParameter("@packAsmTime", SqlDbType.DateTime)};
            parameters[0].Value = model.opWorkerID;
            parameters[1].Value = model.bmsID;
            ...
            parameters[7].Value = model.batPackID;
            parameters[8].Value = model.packAsmTime;
        ...
        public bool DeleteList(string batPackIDlist)
        {
            ...
            int rows = DbHelperSQL.ExecuteSqlByTime(strSql.ToString(), 120);
            if (rows > 0)
            {
                return true;
            }
        ...
        public DBAccess.Model.BatteryPackModel GetModel(string batPackID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 batPackID,packAsmTime,opWorkerID,bmsID,tag1,tag2,tag3,tag4,tag5 from BatteryPack ");
            strSql.Append(" where batPackID=@batPackID ");
            SqlParameter[] parameters = {
					new SqlParameter("@batPackID", SqlDbType.NVarChar,50)			};
            parameters[0].Value = batPackID;
        ...
        public DBAccess.Model.BatteryPackModel DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["bmsID"] != null)
                {
                    model.bmsID = row["bmsID"].ToString();
                }
                if (row["tag1"] != null)
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select batPackID,packAsmTime,opWorkerID,bmsID,tag1,tag2,tag3,tag4,tag5 ");
            strSql.Append(" FROM BatteryPack ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
            strSql.Append(" order by packAsmTime");
            return DbHelperSQL.Query(strSql.ToString(),120);
        }
