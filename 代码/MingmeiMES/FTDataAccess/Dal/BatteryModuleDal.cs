...
namespace DBAccess.DAL
{
    ...
    public partial class BatteryModuleDal
    {
        ...
        public bool Update(DBAccess.Model.BatteryModuleModel model)
        {
            ...
            parameters[11].Value = model.tag1;
            parameters[12].Value = model.tag2;
            parameters[13].Value = model.tag3;
            parameters[14].Value = model.tag4;
            parameters[15].Value = model.tag5;
            parameters[16].Value = model.batModuleID;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select batModuleID,batPackID,batchName,curProcessStage,topcapOPWorkerID,downcapOPWorkerID,palletID,palletBinded,topcapWelderID,bottomcapWelderID,checkResult,tag1,tag2,tag3,tag4,tag5,asmTime ");
        ...
        {
            string strSql = "select distinct batchName from BatteryModule";
            DataSet ds = DbHelperSQL.Query(strSql,120);
            return ds;
        }
        /// <summary>
        /// 获得前几行数据
