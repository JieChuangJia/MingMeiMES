...
{
    public partial class RfidWqwlForm : Form
    {
        WqwlRfidRW rfidRW = null;
        public RfidWqwlForm()
        {
            InitializeComponent();
        ...
        private void buttonConn_Click(object sender, EventArgs e)
        {
            ...
            this.rfidRW = new WqwlRfidRW(EnumTag.TagEPCC1G2, 1, this.textBoxIP.Text,port);
            rfidRW.HostIP = this.textBoxHostIP.Text;// "192.168.1.100";
