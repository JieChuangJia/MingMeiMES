...
namespace LineNodes
{
    public partial class UserControlCtlNode : UserControl
    {
        ...
        private PopupTipinfoDlg popupDlg = null;
       // private Size canvasSize = new Size(100, 100);//大小
       // private bool popdlgShowed = false;
        #endregion
        #region 属性
        public Color BkgColor { get { return bkgColor; } set { bkgColor = value; this.panel1.BackColor = bkgColor; } }
        ...
        public string Title { get { return title; } set { title = value; this.labelNodename.Text = title; } }
